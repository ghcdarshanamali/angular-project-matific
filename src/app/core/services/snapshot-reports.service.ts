...
export class SnapshotReportsService {
  reports = [
    ...
    },
    {
      ...
      attempts: {
        ...
        values: [53, 77, 59, 60, 97, 77, 73, 89],
      },
      student: 'Student 2',
      time: '43m',
      skill: 'Count to 10',
    ...
    },
    {
      id: 7,
      content: 'Early Bird',
      attempts: { weeks: ['15/10/18', '18/09/18'], values: [80, 92] },
      student: 'Student 4',
      time: '30m',
      skill: 'Odd and Even',
      type: 'Activity',
    ...
    },
    {
      id: 18,
      content: 'Early Bird',
      attempts: { weeks: ['15/10/18', '18/09/18'], values: [92, 82] },
      student: 'Student 10',
      time: '30m',
      skill: 'Odd and Even',
      type: 'Activity',
    },
    {
      ...
      attempts: { weeks: ['15/10/18', '18/09/18'], values: [95, 100] },
      student: 'Student 10',
      time: '30m',
      skill: 'Halves',
      type: 'Activity',
  ...
  public fetchClassesAndStudents(): Observable<ClassOfStudents[]> {
    return this.http.get<ClassOfStudents[]>(
